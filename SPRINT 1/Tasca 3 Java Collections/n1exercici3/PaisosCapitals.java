...
public class PaisosCapitals {
	 ...
	 public static void main (String[] args) {
		...
		llegirFitxer("./Tasca 3 Java Collections/countries");
		
		HashMap<String, String> paisosCapitals= new HashMap <>();	
		afegirDadesHashMap("./Tasca 3 Java Collections/countries", paisosCapitals);
		...
		escriureDadesFitxer ("El jugador " +nomUsuari +" ha obtingut un total de " +puntuacio +" punts", "./Tasca 3 Java Collections/resultat.txt");
